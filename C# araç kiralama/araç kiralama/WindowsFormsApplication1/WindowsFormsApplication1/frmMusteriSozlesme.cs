...
{
    public partial class frmMusteriSozlesme : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (sonuc != null)
                {
                    ...
                    MessageBox.Show("Sözleşme Eklenemedi..", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                komut.Dispose();
                baglan.Close();
            }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            komut.Parameters.AddWithValue("@k1", comboBox2.Text);
            komut.ExecuteNonQuery();
            MessageBox.Show("Sozlesme Silindi..");
            adapter = new MySqlDataAdapter("select * from sozlesme", baglan);
